 ...
 *
 *   GET  /servlet-assignment/calculate?a=6&b=3&op=*
 *   POST /servlet-assignment/calculate   with a=6&b=3&op=* as a form-encoded body
 *
 * DIFFERENCE 4 of 6 from the embedded project: there is no @WebServlet annotation on this
 * class. The URL mapping moved to WEB-INF/web.xml. The Java below is otherwise unchanged -
 * a servlet does not know or care how it was mapped.
 *
 * The /servlet-assignment prefix in the URLs above is the CONTEXT PATH, which comes from the
 * WAR's filename. Nothing in this file mentions it, and nothing should: the same code deploys
 * under any prefix.
 *

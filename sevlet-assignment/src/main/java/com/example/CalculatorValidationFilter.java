 ...
 *
 * Mapped with @WebFilter rather than web.xml. The container's annotation scanner finds this
 * class at startup and wires it to /calculate.
 *
 ...
 */
@WebFilter(urlPatterns = "/calculate", filterName = "calculatorValidationFilter")
